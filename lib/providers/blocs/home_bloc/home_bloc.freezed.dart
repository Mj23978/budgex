...
mixin _$HomeEvent {
  ...
  TResult when<TResult extends Object?>({
    ...
    required TResult Function(List<List<Transaction>> barData, double? max,
            double? total, int? average)
        barChart,
  ...
  TResult maybeWhen<TResult extends Object?>({
    ...
    TResult Function(List<List<Transaction>> barData, double? max,
            double? total, int? average)?
        barChart,
  ...
  $Res call({
    ...
    return _then(HomeBarChartEvent(
      barData: barData == freezed
          ? _value.barData
          : barData // ignore: cast_nullable_to_non_nullable
              as List<List<Transaction>>,
      max: max == freezed
          ? _value.max
...
class _$HomeBarChartEvent implements HomeBarChartEvent {
  const _$HomeBarChartEvent(
      {required this.barData, this.max, this.total, this.average});

  @override
  final List<List<Transaction>> barData;
  @override
  final double? max;
  @override
  final double? total;
  ...
  @override
  String toString() {
    return 'HomeEvent.barChart(barData: $barData, max: $max, total: $total, average: $average)';
  }
  ...
  TResult when<TResult extends Object?>({
    ...
    return barChart(barData, max, total, average);
  }
...
abstract class HomeBarChartEvent implements HomeEvent {
  const factory HomeBarChartEvent(
      {required List<List<Transaction>> barData,
      double? max,
      double? total,
      int? average}) = _$HomeBarChartEvent;

  List<List<Transaction>> get barData => throw _privateConstructorUsedError;
